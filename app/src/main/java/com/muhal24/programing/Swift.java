...
public class Swift extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.lswiftvideo);
        ...
        playerView = findViewById(R.id.Videoswift);
        ...
        fullscreenButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(fullscreen) {
                    fullscreenButton.setImageDrawable(ContextCompat.getDrawable(Swift.this, R.drawable.ic_fullscreen_open));
                    ...
                    fullscreenButton.setImageDrawable(ContextCompat.getDrawable(Swift.this, R.drawable.ic_fullscreen_close));
