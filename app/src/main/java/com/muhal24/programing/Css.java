...
public class Css extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.lcssvideo);
        ...
        playerView = findViewById(R.id.Videocss);
        ...
        fullscreenButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(fullscreen) {
                    fullscreenButton.setImageDrawable(ContextCompat.getDrawable(Css.this, R.drawable.ic_fullscreen_open));
                    ...
                    fullscreenButton.setImageDrawable(ContextCompat.getDrawable(Css.this, R.drawable.ic_fullscreen_close));
