...
public class Python extends AppCompatActivity {
    ...
    Boolean is4Clicked = false ;
    Boolean is5Clicked = false ;
    Boolean is6Clicked = false ;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_python);

        // final VideoView videoview = findViewById(R.id.Videogolang);
        listView = (ListView) findViewById(R.id.lpythonvideo);
        ...
        playerView = findViewById(R.id.Videopython);
        ...
        fullscreenButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(fullscreen) {
                    fullscreenButton.setImageDrawable(ContextCompat.getDrawable(Python.this, R.drawable.ic_fullscreen_open));
                    ...
                    fullscreenButton.setImageDrawable(ContextCompat.getDrawable(Python.this, R.drawable.ic_fullscreen_close));
