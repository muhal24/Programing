...
public class Golang extends AppCompatActivity {
   ...
   // VideoView videoview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_golang);


        listView = (ListView) findViewById(R.id.lgolangvideo);
        ...
        playerView = findViewById(R.id.Videogolang);
        ...
        fullscreenButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(fullscreen) {
                    fullscreenButton.setImageDrawable(ContextCompat.getDrawable(Golang.this, R.drawable.ic_fullscreen_open));
                    ...
                    fullscreenButton.setImageDrawable(ContextCompat.getDrawable(Golang.this, R.drawable.ic_fullscreen_close));
