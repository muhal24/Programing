...
public class Java extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.ljavavideo);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    case 0:
                        setVideoURI("https://www.youtube.com/watch?v=2EaopRDxNrw") ;
                        is1Clicked = true ;
                        break ;
        ...
        playerView = findViewById(R.id.Videojava);
        ...
        fullscreenButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(fullscreen) {
                    fullscreenButton.setImageDrawable(ContextCompat.getDrawable(Java.this, R.drawable.ic_fullscreen_open));
                    ...
                    fullscreenButton.setImageDrawable(ContextCompat.getDrawable(Java.this, R.drawable.ic_fullscreen_close));
